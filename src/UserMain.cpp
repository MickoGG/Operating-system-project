...
void userMain() {
//    Thread::setMaximumThreads(2);
//
//    Thread *t1 = new Thread(testBody, nullptr);
//    Thread *t2 = new Thread(testBody, nullptr);
//    Thread *t3 = new Thread(testBody, nullptr);
//    Thread *t4 = new Thread(testBody, nullptr);
//
//    //Thread::dispatch();
//
//    for (int i = 0; i < 3; i++) {
//        printString("a");
//        for (int j = 0; j < 1000000000; j++);    // 1000000000
//    }
//    putc('\n');
//
//    t1->join();
